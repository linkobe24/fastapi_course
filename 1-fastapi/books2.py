...
class BookRequest(BaseModel):
    ...
    published_date: int = Field(gt=1500)
    ...
    def check_year(cls, v):
        ...
        if v > current_year:
            raise ValueError(f"published_date no puede ser mayor a {current_year}")
        return v
...
BOOKS = [
    ...
    Book(4, "HP1", "Author One", "Book Description", 2, published_date=2025),
    Book(5, "HP2", "Author Two", "Book Description", 3, published_date=2025),
    Book(6, "HP3", "Author Three", "Book Description", 1, published_date=2023),
]
